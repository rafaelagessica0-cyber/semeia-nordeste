  ...
  return (
    <div className="min-h-screen bg-[#F5F2ED] flex flex-col items-center justify-center px-6">
      ...
      <div className="w-full max-w-md bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100">
        ...
        <h1 className="text-2xl font-black italic uppercase tracking-widest text-[#394158] mb-8 text-center">
          Bem-vindo de volta
        </h1>
        ...
        <form className="space-y-5">
          <div className="relative">
            ...
            {/* Borda no foco: Cor original Green (#2D3A27) -> Novo Primary Earth (#394158) */}
          ...
          <button
            type="submit"
            // Botão: Cor original Vinho (#B22246) -> Novo Verde Musgo (#55833d)
